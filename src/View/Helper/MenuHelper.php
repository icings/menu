...
class MenuHelper extends Helper
{
     ...
     */
    public function extractPath(ItemInterface $item, array $options = [])
    {
        $options += [
            'includeRoot' => false,
        ];
     ...
     */
    public function getCurrentItem($menu = null, array $options = [])
    {
        if (is_array($menu)) {
            $options = $menu;
            $menu = null;
     ...
     * @return ItemInterface
     */
    protected function _getMenu($menu = null)
    {
        if ($menu === null) {
     ...
     */
    protected function _getMatcher(array $options)
    {
     ...
     */
    protected function _getVoters(array $options)
    {
     ...
     */
    protected function _getRenderer(array $options)
    {
     ...
     */
    protected function _findCurrentItem(ItemInterface $item, MatcherInterface $matcher)
    {
