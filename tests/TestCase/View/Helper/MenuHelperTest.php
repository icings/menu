...
class MenuHelperTest extends TestCase
{
    ...
    public function testCreateMenuReceivesOnlyMenuOptions()
    {
        ...
        /** @var MenuFactoryInterface|\PHPUnit_Framework_MockObject_MockObject $factory */
        $factory = $this
    ...
    public function testExtractPathFromExternalNode()
    {
        $menu = $this->Menu->create('menu');
    ...
    public function testExtractPathFromInternalNode()
    {
        $menu = $this->Menu->create('menu');
    ...
    public function testExtractPathNoParentItemsPresent()
    {
        $menu = $this->Menu->create('menu');
    ...
    public function testExtractPathReturnsClones()
    {
        $menu = $this->Menu->create('menu');
    ...
    public function testExtractPathInvalidMenuType()
    {
        $this->skipIf(PHP_MAJOR_VERSION < 7);
    ...
    public function testExtractPathIncludeRootItem()
    {
        $menu = $this->Menu->create('menu');
    ...
    public function testExtractPathNoParentItemsPresentIncludeRootItem()
    {
        $menu = $this->Menu->create('menu');
    ...
    public function testExtractPathInvalidOptionsType()
    {
        $this->skipIf(PHP_MAJOR_VERSION < 7);
    ...
    public function testGetCurrentItemFromLastCreatedMenu()
    {
    ...
    public function testGetCurrentItemFromLastCreatedMenuNoMenuHasBeenCreated()
    {
    ...
    public function testGetCurrentItemFromNamedMenu()
    {
        $other = $this->Menu->create('other');
        $other->addChild('Parent', ['uri' => '/parent']);
        $other['Parent']->addChild('Child', ['uri' => '/parent/child'])->setCurrent(true);
    ...
    public function testGetCurrentItemFromNamedMenuMenuDoesNotExist()
    {
    ...
    public function testGetCurrentItemFromMenuObject()
    {
    ...
    public function testGetCurrentItemRetrievesTheFirstCurrentItem()
    {
        $menu = $this->Menu->create('main');
        $menu->addChild('Parent', ['uri' => '/parent']);
    ...
    public function testGetCurrentItemUsingMatcherWithVoters()
    {
    ...
    public function testGetCurrentItemInvalidMenuType()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function getCurrentItemMergeWithHelperOptionsTestSetup()
    {
        $voter1 = $this
            ->getMockBuilder(VoterInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemMergeWithHelperOptionsNoMenuArgument()
    {
        $test = $this->getCurrentItemMergeWithHelperOptionsTestSetup();
        $test['helper']->getCurrentItem(null, $test['getCurrentItemOptions']);
    }

    public function testGetCurrentItemMergeWithHelperOptionsGetCurrentItemOptionsViaMenuArgument()
    {
        $test = $this->getCurrentItemMergeWithHelperOptionsTestSetup();
        $test['helper']->getCurrentItem($test['getCurrentItemOptions']);
    }

    public function testGetCurrentItemMergeWithHelperOptionsNamedMenu()
    {
        $test = $this->getCurrentItemMergeWithHelperOptionsTestSetup();
        $test['helper']->getCurrentItem($test['menu']->getName(), $test['getCurrentItemOptions']);
    }

    public function testGetCurrentItemMergeWithHelperOptionsMenuInstance()
    {
        $test = $this->getCurrentItemMergeWithHelperOptionsTestSetup();
        $test['helper']->getCurrentItem($test['menu'], $test['getCurrentItemOptions']);
    }

    public function testGetCurrentItemDefaultMatchingOption()
    {
        $menu = $this
            ->getMockBuilder(ItemInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemUrlMatchingOption()
    {
        $menu = $this
            ->getMockBuilder(ItemInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemUrlWithQueryStringMatchingOption()
    {
        $menu = $this
            ->getMockBuilder(ItemInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemFuzzyRouteMatchingOption()
    {
        $menu = $this
            ->getMockBuilder(ItemInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemInvalidMatchingOption()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testGetCurrentItemMatcherOption()
    {
        $menu = $this
            ->getMockBuilder(ItemInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemInvalidMatcherOption()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testGetCurrentItemVotersOption()
    {
        $menu = $this
            ->getMockBuilder(ItemInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemInvalidVotersOption()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testGetCurrentItemInvalidVotersOptionArray()
    {
        $this->skipIf(PHP_MAJOR_VERSION < 7);
    ...
    public function testGetCurrentItemMatcherClearedByDefault()
    {
        $matcher = $this
            ->getMockBuilder(Matcher::class)
            ->setMethods(['clear'])
    ...
    public function testGetCurrentItemDoNotClearMatcher()
    {
        $matcher = $this
            ->getMockBuilder(Matcher::class)
            ->setMethods(['clear'])
    ...
    public function testGetCurrentItemOptionsOnly()
    {
        $voter = $this
            ->getMockBuilder(VoterInterface::class)
            ->getMock();
    ...
    public function testGetCurrentItemInvalidOptionsType()
    {
        $this->skipIf(PHP_MAJOR_VERSION < 7);
